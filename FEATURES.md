...
| Gelir/gider işlemleri | Devam ediyor | Liste ve yenilenen filtreleme; sıcak-lüks Hızlı Ekle (+ modal sheet); sıcak-lüks işlem formu (büyük tutar, zorunlu 100 kar. işlem adı, kategori, ödeme yöntemi, tarih, isteğe bağlı not/taksit/makbuz/split akordiyonu); Room SSOT başarı ekranı; Room v14→v15 note kolonu; aktif workspace para birimine göre güvenli özet ve farklı para birimli işlemleri listede koruyan açıklamalı dışlama davranışı tamamlandı; hedefli testler ve debug APK derlemesi başarılı | Android emülatör manuel smoke kabulü (uygulandı, manuel kabul bekliyor) |
