...
object RepositoryModule {
    ...
    fun provideSubscriptionRepository(
        ...
        subscriptionPriceHistoryDao: com.feniqo.mobile.data.local.dao.SubscriptionPriceHistoryDao,
        subscriptionPaymentDao: com.feniqo.mobile.data.local.dao.SubscriptionPaymentDao,
        offlineWriteQueue: OfflineWriteQueue,
        entityIdGenerator: com.feniqo.mobile.domain.model.EntityIdGenerator,
        activeWorkspaceScope: ActiveWorkspaceScope,
        ...
        com.feniqo.mobile.data.repository.OfflineFirstSubscriptionRepository(
            ...
            subscriptionPriceHistoryDao = subscriptionPriceHistoryDao,
