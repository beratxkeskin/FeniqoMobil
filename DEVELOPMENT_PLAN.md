...
- Profil ve Ayarlar deneyimi kodlandı; Room SSOT profil özeti ViewModel katmanında, erişilebilir yuvarlatılmış ayar kartları ve type-safe Ortak Alanlar navigasyonu eklendi. Görünüm, biyometri/cihaz kilidi, otomatik kilit, CSV dışa aktarma, JSON içe aktarma ve güvenli çıkış mevcut akışlara bağlandı. Gradle doğrulaması çevresel süreç kesintisi nedeniyle yeniden çalıştırılmayı bekliyor.
